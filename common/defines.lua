...
NMilitary = {
	...
	LIGHT_INFANTRY_PHASE_SKIRMISH_ATTACK = 0.75,
	LIGHT_INFANTRY_PHASE_MELEE_ATTACK = 4,
	LIGHT_INFANTRY_PHASE_PURSUE_ATTACK = 1.5,
	LIGHT_INFANTRY_PHASE_SKIRMISH_DEFENSE = 2,
	LIGHT_INFANTRY_PHASE_MELEE_DEFENSE = 1.5,
	LIGHT_INFANTRY_PHASE_PURSUE_DEFENSE = 3LIGH,
	LIGHT_INFANTRY_GRAPHICAL_FACTOR = 1,

	HEAVY_INFANTRY_MORALE = 1,
	HEAVY_INFANTRY_MAINTENANCE = 3,
	HEAVY_INFANTRY_PHASE_SKIRMISH_ATTACK = 3.5,
	HEAVY_INFANTRY_PHASE_MELEE_ATTACK = 0.5,
	HEAVY_INFANTRY_PHASE_PURSUE_ATTACK = 2,
	HEAVY_INFANTRY_PHASE_SKIRMISH_DEFENSE = 2,
	HEAVY_INFANTRY_PHASE_MELEE_DEFENSE = 0.5,
	HEAVY_INFANTRY_PHASE_PURSUE_DEFENSE = 2,
	HEAVY_INFANTRY_GRAPHICAL_FACTOR = 1.25,

	PIKEMEN_MORALE = 6,
	PIKEMEN_MAINTENANCE = 4,
	PIKEMEN_PHASE_SKIRMISH_ATTACK = 1,
	PIKEMEN_PHASE_MELEE_ATTACK = 0.5,
	PIKEMEN_PHASE_PURSUE_ATTACK = 6,
	PIKEMEN_PHASE_SKIRMISH_DEFENSE = 1,
	PIKEMEN_PHASE_MELEE_DEFENSE = 0.5,
	PIKEMEN_PHASE_PURSUE_DEFENSE = 6,
	PIKEMEN_GRAPHICAL_FACTOR = 1.5,

	LIGHT_CAVALRY_MORALE = 7,
	LIGHT_CAVALRY_MAINTENANCE = 4,
	LIGHT_CAVALRY_PHASE_SKIRMISH_ATTACK = 1.5,
	LIGHT_CAVALRY_PHASE_MELEE_ATTACK = 6,
	LIGHT_CAVALRY_PHASE_PURSUE_ATTACK = 5,
	LIGHT_CAVALRY_PHASE_SKIRMISH_DEFENSE = 4,
	LIGHT_CAVALRY_PHASE_MELEE_DEFENSE = 4,
	LIGHT_CAVALRY_PHASE_PURSUE_DEFENSE = 5.5,
	LIGHT_CAVALRY_GRAPHICAL_FACTOR = 1,

	KNIGHTS_MORALE = 5,
	KNIGHTS_MAINTENANCE = 2,
	KNIGHTS_PHASE_SKIRMISH_ATTACK = 0.25,
	KNIGHTS_PHASE_MELEE_ATTACK = 6,
	KNIGHTS_PHASE_PURSUE_ATTACK = 2,
	KNIGHTS_PHASE_SKIRMISH_DEFENSE = 1,
	KNIGHTS_PHASE_MELEE_DEFENSE = 4,
	KNIGHTS_PHASE_PURSUE_DEFENSE = 1,
	...
	SPECIAL_TROOPS_MORALE = 12,
	SPECIAL_TROOPS_MAINTENANCE = 7,
	SPECIAL_TROOPS_PHASE_SKIRMISH_ATTACK = 3,
	SPECIAL_TROOPS_PHASE_MELEE_ATTACK = 9,
	SPECIAL_TROOPS_PHASE_PURSUE_ATTACK = 4,
	SPECIAL_TROOPS_PHASE_SKIRMISH_DEFENSE = 2,
	SPECIAL_TROOPS_PHASE_MELEE_DEFENSE = 7,
	SPECIAL_TROOPS_PHASE_PURSUE_DEFENSE = 4,
