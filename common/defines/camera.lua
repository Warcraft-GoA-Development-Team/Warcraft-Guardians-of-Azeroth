...
NDefines.NFrontend.CAMERA_START_X = 1300.0
NDefines.NFrontend.CAMERA_START_Y = 100.0
NDefines.NFrontend.CAMERA_START_Z = 1500.0
-- Move to position in main menu
NDefines.NFrontend.CAMERA_END_X = 825.0
NDefines.NFrontend.CAMERA_END_Y = 500.0
NDefines.NFrontend.CAMERA_END_Z = 1500.0
-- Rotation point in main menu
NDefines.NFrontend.CAMERA_LOOKAT_X = 1300.0
NDefines.NFrontend.CAMERA_LOOKAT_Y = 0.0
NDefines.NFrontend.CAMERA_LOOKAT_Z = 1500.0

-- Move to position in settings
NDefines.NFrontend.SETTINGS_POS_X = 1815.0
NDefines.NFrontend.SETTINGS_POS_Y = 50.0
NDefines.NFrontend.SETTINGS_POS_Z = 1930.0
NDefines.NFrontend.SETTINGS_LOOK_X = 1875.0
NDefines.NFrontend.SETTINGS_LOOK_Y = 0.0
NDefines.NFrontend.SETTINGS_LOOK_Z = 2010.0
-- Rotation point in settings
NDefines.NFrontend.CAMERA_LOOKAT_SETTINGS_X = 1875.0
